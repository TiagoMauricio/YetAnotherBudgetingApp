...
async def update_transaction(
    ...
    transaction: Transaction | None = t_crud.find_transaction_by_id(transaction_data.transaction_id, session)
    if not transaction:
        raise HTTPException(
    ...
    updated_transaction: TransactionResponse | None = t_crud.update_transaction(transaction_data, user, session)
